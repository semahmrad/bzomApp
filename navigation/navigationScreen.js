...
import UpdateHashtags from './../components/hashtagsAndInterestsAndPersonalInfos/upstaeHashtags';
  ...
  return (
    <NavigationContainer>
      <Stack.Navigator sccreenOption={{headerShown: false}}>
        ...
        <Stack.Screen
          name="validation"
          component={ValidationByEmail}
          options={{tabBarShowLabel: true, headerShown: false}}
        />
        <Stack.Screen
          name="updateHashtags"
          component={UpdateHashtags}
          options={{tabBarShowLabel: true, headerShown: false}}
        />
        ...
        />
        <Stack.Screen
          name="getStartedProfilePick"
          component={GetStartedProfilePick}
          options={{tabBarShowLabel: true, headerShown: false}}
        />
